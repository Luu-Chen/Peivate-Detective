$(function () {
    ...
    switch (ID){
        case 'sgas@gmail.com':
            ...
            break;
        case 'tk0100618@gmail.com':
            document.querySelector('.rank').style.display="block"
            document.querySelector('.rank-one').style.display="block"
            break;
        default:
            console.log('你不是管理員，無權操作')
    }
    if(localStorage.getItem('img')==null){
        ...
        document.getElementById('adduserImg').src = 'https://firebasestorage.googleapis.com/v0/b/concent-4b5ff.appspot.com/o/user.svg?alt=media&token=d1b32bc6-b569-4c60-8831-ccd7b571f682';
    }else{
